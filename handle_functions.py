...
def file_exist(filename):
    if os.path.exists(f"./data/{filename}.xlsx"):
        print(f"File exists in './data/{filename}.xlsx'")
        return True
    else:
        print(f"File does not exist in './data/{filename}.xlsx'")
        return False
...
testlist = {'DRIVER_NO': ['20'], 'IC_NO': [''], 'LORRY_NO': [''], 'COMISSION': [''], 'BASIC': [''], 'ROAD_TAX': [''],
            'INSPECTION': ['']}
testlist2 = {}
